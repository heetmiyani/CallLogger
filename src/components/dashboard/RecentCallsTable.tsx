...
export default function RecentCallsTable({ limit = 5, showStaff = true, filterByStaff }: RecentCallsTableProps) {
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-muted/50">
              <th className="text-left text-sm font-medium text-muted-foreground px-6 py-3">Client</th>
              ...
              {showStaff && (
                <th className="text-left text-sm font-medium text-muted-foreground px-6 py-3">Staff</th>
              )}
              <th className="text-left text-sm font-medium text-muted-foreground px-6 py-3">Date & Time</th>
            </tr>
          </thead>
          <tbody>
            {recentLogs.map((log) => (
